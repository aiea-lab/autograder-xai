...
"""
You are writing a program to help design signs for a local community fair. 
Your program will receive a slogan from each participant and needs to be able to transform the sentence 
into the desired format so it can be neatly fit onto a sign that follows the fair's specifications.
...
Write your solution in the function 'frame_printing' below:

When you're ready to test, please run: `python grader.py` or `python3 grader.py`, depending on your system's configuration.
"""
